...
import (
	...
	"github.com/cloudpilot-ai/hermes/pkg/common/archive/compression"
	"github.com/cloudpilot-ai/hermes/pkg/common/config"
	socihttp "github.com/cloudpilot-ai/hermes/pkg/common/httputil"
	...
	bf "github.com/cloudpilot-ai/hermes/pkg/daemon/fs/backgroundfetcher"
	...
	layermetrics "github.com/cloudpilot-ai/hermes/pkg/daemon/fs/metrics/layer"
	"github.com/cloudpilot-ai/hermes/pkg/daemon/fs/remote"
	"github.com/cloudpilot-ai/hermes/pkg/daemon/fs/source"
	"github.com/cloudpilot-ai/hermes/pkg/daemon/grpc/resolver"
	"github.com/cloudpilot-ai/hermes/pkg/daemon/metadata"
	"github.com/cloudpilot-ai/hermes/pkg/daemon/snapshot"
...
func NewFilesystem(ctx context.Context, root string, cfg config.FSConfig, opts ...Option) (_ snapshot.FileSystem, err error) {
	...
	return &filesystem{
		...
		pr:                          pr,
		pullModes:                   pullModes,
		externalArtifactStore:       cfg.ExternalArtifactStoreConfig,
		containerd:                  client,
